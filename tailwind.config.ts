...
export default {
  ...
  theme: {
    ...
    extend: {
      ...
      boxShadow: {
        soft: "0 8px 28px -10px hsl(270 55% 30% / 0.08)",
        card: "0 14px 44px -16px hsl(270 55% 30% / 0.12)",
        elevated: "0 28px 70px -22px hsl(270 55% 30% / 0.18)",
        glow: "0 18px 60px -20px hsl(270 55% 30% / 0.25)",
        "glow-gold": "0 18px 60px -22px hsl(43 56% 54% / 0.45)",
        "glow-rose": "0 18px 60px -22px hsl(350 71% 76% / 0.55)",
        ring: "0 0 0 1px hsl(270 55% 30% / 0.06)",
      },
    },
  },
